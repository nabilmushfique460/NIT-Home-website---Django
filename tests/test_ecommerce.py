...
class NITHomeECommerceTests(TestCase):
    ...
    def test_checkout_cod_order_creation(self):
        ...
        payload = {'full_name': 'Nabil Hasan', 'email': 'nabil@example.com', 'phone': '+880 1812345678', 'street_address': 'House 10, Road 4, Banani', 'city': 'Dhaka', 'state_or_division': 'Dhaka Division', 'postal_code': '1213', 'payment_method': 'COD'}
    ...
    def test_checkout_bkash_strategy_payment(self):
        self.client.post(reverse('cart:cart_add', kwargs={'product_id': self.product.id}), {'quantity': 1})
        checkout_url = reverse('orders:checkout')
        payload = {'full_name': 'Imtiaz Ahmed', 'email': 'imtiaz@example.com', 'phone': '+880 1712345678', 'street_address': 'Sector 3, Uttara', 'city': 'Dhaka', 'postal_code': '1230', 'payment_method': 'BKASH'}
